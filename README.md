...
Breaking changes must be marked with `!` before `:` in the subject line. Also `BREAKING CHANGE:` should be described in the commit footer section, if the commit description isn't sufficiently informative.
